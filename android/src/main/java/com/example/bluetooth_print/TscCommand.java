...
public class TscCommand {
    ...
    public void addDirection(TscCommand.DIRECTION direction, TscCommand.MIRROR mirror) {
        new String();
    ...
    public void addQRCode(int x, int y, TscCommand.EEC level, int cellwidth, TscCommand.ROTATION rotation, String data) {
        new String();
